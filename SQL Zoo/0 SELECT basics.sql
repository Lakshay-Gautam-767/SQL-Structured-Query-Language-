...
# Q-1: (Introducing the world table of countries)
...
# Q-2: (Scandinavia)
# Checking a list The word IN allows us to check if an item is in a 
-- list. The example shows the name and population for the countries 
